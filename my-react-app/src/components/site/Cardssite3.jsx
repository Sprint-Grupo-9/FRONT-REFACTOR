  ...
  return (
    <div className='w-80 h-40 rounded-2xl bg-card-grey flex float-start items-center p-4'>
      ...
      <div className='w-2/3 h-full flex flex-col justify-center items-start pl-4'>
        ...
        <button onClick={handleAgendar} className='bg-[#23C3E3] text-white font-bold font-figtree py-2 px-6 rounded-lg transition-all duration-900 hover:bg-white hover:text-[#3B82F6]'>Agendar</button>
      </div>
    </div>
  )
}
